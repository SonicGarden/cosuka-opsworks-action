...
const getCrontab = () => __awaiter(void 0, void 0, void 0, function* () {
    const { stdout } = yield execa_1.command('bundle exec rake cosuka_opsworks:output_cron', {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const newCrontab = yield getCrontab();
